-- ============================================================
-- COMPLETE FIX FOR PRODUCTION DATABASE
-- Run this in Supabase SQL Editor
-- ============================================================

-- 1. Drop old trigger and function first
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
DROP FUNCTION IF EXISTS public.handle_new_user();

-- 2. Drop old tables (CASCADE removes dependencies)
...
-- ============================================================
-- Now recreate the CORRECT schema (from client/supabase/schema.sql)
-- ============================================================
...
create table public.bookings (
  ...
  service_type       text not null check (service_type in ('maid','nurse','driver','cook','repair','physiotherapist')),
  scheduled_at       timestamptz not null,
  duration_hours     int default 2,
  status             text default 'pending' check (status in ('pending','confirmed','active','done','cancelled')),
  notes              text null,
