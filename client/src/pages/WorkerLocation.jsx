  ...
  return (
    <WorkerLayout>
      <div style={{ minHeight: '80vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: 24 }}>
        ...
        <h1 style={{ fontSize: 22, fontWeight: 800, color: '#0A2540', marginBottom: 8 }}>My Location</h1>
        <p style={{ fontSize: 14, color: '#5A7A9A', marginBottom: 32 }}>Location tracking coming in Phase 5</p>
