  ...
  return (
    <ElderLayout>
      <div style={{ minHeight: '100vh', background: '#EBF4FF', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 24, textAlign: 'center' }}>
        <div style={{ width: 48, height: 48, background: '#E24B4A', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
          <i className="ti ti-heart-rate-monitor" style={{ color: 'white', fontSize: 22 }} />
        </div>
        <h1 style={{ fontSize: 22, fontWeight: 800, color: '#0A2540', marginBottom: 8 }}>Health Log</h1>
        <p style={{ fontSize: 14, color: '#5A7A9A', marginBottom: 32 }}>Full health logging coming in Phase 5</p>
